...
local Window = OrionLib:MakeWindow({Name = "Blox Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Blox Hub"})
...
local W = Window:MakeTab({
    Name = "Welcome",
    Icon = "rbxassetid://98657568985652",
    PremiumOnly = false
})
